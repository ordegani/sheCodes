...
const Movie = ({movie_title, movie_name, movie_posterPath, movie_voteAverage, movie_releaseDate, movie_overview }) => {

    return (
        <div className="movie_item" >
        <div className="movie_title">{movie_title? movie_title: movie_name}</div>
